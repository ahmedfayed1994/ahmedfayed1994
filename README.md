...
### Engaz CRM (Dec 2022 - Present)
**Senior Backend Developer**
- Developed and maintained backend systems for messaging portals and CRM using Laravel.
- Created and integrated RESTful APIs for seamless communication with external services.
- Designed and managed relational database schemas for optimized performance.

### Aljanahain (Dec 2024 - Present)
**Backend Developer**
- Developed APIs and web applications using Laravel.
- Designed efficient database schemas and optimized queries.
- Implemented authentication and authorization mechanisms for enhanced security.

### TopLine (2022 - Jul 2024)
**Full Stack Developer**
- Led the end-to-end development of web applications.
- Built responsive UIs using JavaScript, HTML, and CSS.
- Developed scalable backend applications with Laravel.

### Uplift Plus (2020 - 2021)
